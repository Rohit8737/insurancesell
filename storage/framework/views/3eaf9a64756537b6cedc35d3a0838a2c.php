...
<head>
    ...
    <title><?php echo e($post->meta_title ?? $post->title); ?> | <?php echo e(setting('site_name', 'InsuranceSell')); ?></title>
    <meta name="description" content="<?php echo e($post->meta_description ?? Str::limit(strip_tags($post->description), 160)); ?>">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(setting('adsense_publisher_id')): ?>
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=<?php echo e(setting('adsense_publisher_id')); ?>" crossorigin="anonymous"></script>
    ...
    <?php echo \App\Helpers\SchemaHelper::generateForPost($post); ?>


    
    <meta property="og:type" content="article">
    <meta property="og:title" content="<?php echo e($post->meta_title ?? $post->title); ?>">
    <meta property="og:description" content="<?php echo e($post->meta_description ?? Str::limit(strip_tags($post->description), 160)); ?>">
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <meta property="og:site_name" content="<?php echo e(setting('site_name', 'InsuranceSell')); ?>">

    
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="<?php echo e($post->meta_title ?? $post->title); ?>">
    <meta name="twitter:description" content="<?php echo e($post->meta_description ?? Str::limit(strip_tags($post->description), 160)); ?>">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($post->featured_image): ?>
    <meta name="twitter:image" content="<?php echo e(asset('storage/' . $post->featured_image)); ?>">
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="flex items-center justify-between h-16">
            <a href="<?php echo e(url('/')); ?>" class="flex items-center gap-2 group">
                ...
                <span class="text-xl font-bold bg-gradient-to-r from-orange-400 via-red-400 to-pink-400 bg-clip-text text-transparent">
                    <?php echo e(setting('site_name', 'InsuranceSell')); ?>
...
<main class="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
    <div class="max-w-lg mx-auto px-4 pt-8 pb-36">
        ...
        <?php echo $__env->make('components.ad-slot', ['slot' => 'ad_slot_1'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <div class="relative rounded-2xl overflow-hidden shadow-2xl mb-6 ring-2 ring-orange-500/30 glow">
            <img 
                ...
                data-src="<?php echo e(asset('storage/' . $post->featured_image)); ?>" 
        ...
        <?php echo $__env->make('components.ad-slot', ['slot' => 'ad_slot_2'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <div class="bg-gradient-to-r from-yellow-900/40 to-orange-900/40 border border-yellow-500/30 rounded-2xl p-5 mb-6 backdrop-blur-sm shadow-xl">
            <p class="text-yellow-300 text-center text-lg font-medium leading-relaxed">
                <?php echo e($post->bridge_text ?? '💡 Discover why smart financial planning can change your life...'); ?>
        ...
        <div class="flex flex-wrap items-center gap-3 mb-6">
            ...
            <span class="flex items-center gap-1.5 px-3 py-1.5 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-500/30 rounded-full text-blue-300 text-xs font-medium">
                ⏱️ <?php echo e($readingTime); ?> min read
            </span>
            ...
            <span class="flex items-center gap-1.5 px-3 py-1.5 bg-gradient-to-r from-green-500/20 to-emerald-500/20 border border-green-500/30 rounded-full text-green-300 text-xs font-medium">
                👁️ <?php echo e(number_format($post->views)); ?> views
            </span>
        ...
        <?php echo $__env->make('components.ad-slot', ['slot' => 'ad_slot_3'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($post->video_path): ?>
        ...
        >
            ...
            <div x-ref="videoContainer" data-video-src="<?php echo e(asset('storage/' . $post->video_path)); ?>" class="relative z-10">
                
                <img 
                    x-ref="thumbnail"
                    src="<?php echo e($post->featured_image ? asset('storage/' . $post->featured_image) : 'data:image/svg+xml,%3Csvg xmlns=%27http://www.w3.org/2000/svg%27 width=%27800%27 height=%27450%27%3E%3Crect fill=%27%23000%27 width=%27800%27 height=%27450%27/%3E%3Ctext x=%2750%25%27 y=%2750%25%27 fill=%27%23666%27 font-size=%2724%27 text-anchor=%27middle%27 dy=%27.3em%27%3EClick to Play Video%3C/text%3E%3C/svg%3E'); ?>"
                    alt="<?php echo e($post->title); ?> - Video Thumbnail"
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($nextPost): ?>
        <a 
            href="<?php echo e(route('post.show', $nextPost->slug)); ?>"
        ...
        <?php echo $__env->make('components.ad-slot', ['slot' => 'ad_slot_4'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        
        <div class="flex justify-center gap-3 mb-8">
            <a href="https://wa.me/?text=<?php echo e(urlencode($post->title . ' ' . url()->current())); ?>" target="_blank" class="w-12 h-12 flex items-center justify-center rounded-full bg-green-600 hover:bg-green-500 transition shadow-lg">
            ...
            <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(urlencode(url()->current())); ?>" target="_blank" class="w-12 h-12 flex items-center justify-center rounded-full bg-blue-600 hover:bg-blue-500 transition shadow-lg">
                <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </a>
            <a href="https://twitter.com/intent/tweet?text=<?php echo e(urlencode($post->title)); ?>&url=<?php echo e(urlencode(url()->current())); ?>" target="_blank" class="w-12 h-12 flex items-center justify-center rounded-full bg-black hover:bg-gray-800 transition shadow-lg border border-gray-700">
        ...
        <div class="bg-gradient-to-br from-slate-800/50 to-slate-900/50 rounded-2xl p-6 mb-8 border border-slate-700/50 backdrop-blur-sm">
            <div class="flex items-center gap-4">
                <div class="w-16 h-16 rounded-full bg-gradient-to-br from-orange-500 to-red-500 flex items-center justify-center text-2xl font-bold text-white shadow-xl">
                    <?php echo e(setting('author_avatar', '👨‍💼')); ?>

                </div>
                <div class="flex-1">
                    <h4 class="text-white font-bold text-lg"><?php echo e(setting('author_name', 'Insurance Expert')); ?></h4>
                    <p class="text-gray-400 text-sm"><?php echo e(setting('author_bio', 'Certified financial advisor with 10+ years of experience in insurance planning.')); ?></p>
                </div>
            </div>
            <div class="flex gap-3 mt-4 pt-4 border-t border-slate-700/50">
                ...
                <a href="<?php echo e(setting('social_facebook')); ?>" target="_blank" class="w-10 h-10 flex items-center justify-center rounded-full bg-blue-600/20 hover:bg-blue-600/40 border border-blue-500/30 text-blue-400 transition">
                ...
                <a href="<?php echo e(setting('social_instagram')); ?>" target="_blank" class="w-10 h-10 flex items-center justify-center rounded-full bg-pink-600/20 hover:bg-pink-600/40 border border-pink-500/30 text-pink-400 transition">
                ...
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(setting('social_youtube')): ?>
                <a href="<?php echo e(setting('social_youtube')); ?>" target="_blank" class="w-10 h-10 flex items-center justify-center rounded-full bg-red-600/20 hover:bg-red-600/40 border border-red-500/30 text-red-400 transition">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                </a>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(setting('social_twitter')): ?>
                <a href="<?php echo e(setting('social_twitter')); ?>" target="_blank" class="w-10 h-10 flex items-center justify-center rounded-full bg-gray-600/20 hover:bg-gray-600/40 border border-gray-500/30 text-gray-400 transition">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                </a>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        ...
        <div class="mb-8">
            ...
            <div class="space-y-3">
                ...
                <a href="<?php echo e(route('post.show', $related->slug)); ?>" class="block bg-gradient-to-r from-slate-800/50 to-slate-900/50 rounded-xl p-4 border border-slate-700/30 hover:border-orange-500/50 transition group">
                    <div class="flex gap-4 items-center">
                        ...
                        <img src="<?php echo e(asset('storage/' . $related->featured_image)); ?>" alt="<?php echo e($related->title); ?>" class="w-20 h-20 rounded-lg object-cover flex-shrink-0">
                        <?php else: ?>
                        ...
                        <div class="flex-1 min-w-0">
                            <h4 class="text-white font-semibold text-sm group-hover:text-orange-400 transition line-clamp-2"><?php echo e($related->title); ?></h4>
                            <p class="text-gray-500 text-xs mt-1"><?php echo e(number_format($related->views)); ?> views</p>
                        </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($stickyAdEnabled): ?>
    <div 
        x-data="{ closed: false }"
        x-show="!closed"
        x-transition:enter="transition ease-out duration-300"
    ...
    >
        ...
        <div class="max-w-lg mx-auto p-3">
            <div class="ad-slot rounded-xl overflow-hidden">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($stickyAdCode): ?>
                    <?php echo $stickyAdCode; ?>

                <?php else: ?>
                    <div class="bg-gradient-to-r from-orange-500 via-red-500 to-pink-500 rounded-xl p-4 text-center">
                        <span class="text-white font-semibold text-sm"><?php echo e($stickyBannerText); ?></span>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </div>
...
<footer class="bg-gradient-to-b from-slate-950 to-black border-t border-slate-800/50 py-10 pb-28">
    <div class="max-w-lg mx-auto px-4">
        <div class="text-center mb-8">
            ...
            <p class="text-gray-400 text-sm"><?php echo e(setting('site_description', 'Your Trusted Insurance Guide')); ?></p>
        </div>
        
        <nav class="flex flex-wrap justify-center gap-x-5 gap-y-2 mb-8 text-sm">
            <a href="<?php echo e(url('/about')); ?>" class="text-gray-400 hover:text-orange-400 transition">About</a>
            <a href="<?php echo e(url('/contact')); ?>" class="text-gray-400 hover:text-orange-400 transition">Contact</a>
            <a href="<?php echo e(url('/privacy-policy')); ?>" class="text-gray-400 hover:text-orange-400 transition">Privacy</a>
            <a href="<?php echo e(url('/terms')); ?>" class="text-gray-400 hover:text-orange-400 transition">Terms</a>
            <a href="<?php echo e(url('/disclaimer')); ?>" class="text-gray-400 hover:text-orange-400 transition">Disclaimer</a>
        </nav>
        ...
        <p class="text-center text-gray-600 text-xs">
            © <?php echo e(date('Y')); ?> <?php echo e(setting('site_name', 'InsuranceSell')); ?>
...
<?php /**PATH C:\xampp\htdocs\insurancesell\resources\views/posts/show.blade.php ENDPATH**/ ?>